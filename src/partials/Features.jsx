        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8 mt-20">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0" data-aos="zoom-y-out" ref={tabs}>
              <div className="relative flex flex-col text-center lg:text-right mr-10">
                {/* Item 1 */}
                <Transition
                  show={tab === 1}
                  appear={true}
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6  md:order-1" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8 mt-20">
                <h3 className="h3 mb-3 ml-20">Powerful suite of tools</h3>
                <p className="text-xl text-gray-600 ml-20">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa.</p>
              </div>
            </div>
          </div >
